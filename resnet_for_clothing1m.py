...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000):
        ...
        self.fc_conf=nn.Linear(512 * block.expansion, 1)
...
# get the pretained parameter for original layers.
def resnet50_conf(num_classes=14):
    from resnet_for_clothing1m import resnet50
    new_resnet50_conf_model = resnet50()
    from torchvision.models import resnet50
    ori_resnet50_model = resnet50(pretrained=False)
    pretrained_dict = ori_resnet50_model.state_dict()
    new_resnet50_conf_dict=new_resnet50_conf_model.state_dict()

    pretrained_dict ={k: v for k, v in pretrained_dict.items() if k in new_resnet50_conf_dict}

    new_resnet50_conf_dict.update(pretrained_dict)
    new_resnet50_conf_model.load_state_dict(new_resnet50_conf_dict)

    num_ftrs = new_resnet50_conf_model.fc.in_features
    new_resnet50_conf_model.fc = nn.Linear(num_ftrs, num_classes)

    return new_resnet50_conf_model

# def test():
#     net = resnet50_conf(14)
#     print(net)
#     from torch.autograd import Variable
#     import torch
#     y1, c1 = net(Variable(torch.randn(3, 3, 224, 224)))
#     print(y1.size())
#     print(c1.size())
#
# test()